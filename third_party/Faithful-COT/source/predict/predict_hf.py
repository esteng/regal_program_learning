...
if __name__ == "__main__":
	...
	Parser.add_argument("--api_key_ids", help="The API keys to use.", default="['openai']")
	Parser.add_argument("--seed", type=int, help="The random seed to use.", default=12)
	...
	# predict
	output_dir = f"output_dir/{dataset_name}/{split}/{model_name}_{args.seed}_seed"
